...
class LightViTFPN(nn.Module):
    r"""Feature Pyramid Network for LightViT.
    ...
    def __init__(self,
        ...
        super(LightViTFPN, self).__init__()
    ...
    def forward(self, inputs):
        ...
        if self.num_outs > len(outs) + len(extra_laterals):
            ...
            # add conv layers on top of original feature maps (RetinaNet)
                ...
                for i in range(used_backbone_levels + 1, self.num_outs - len(extra_laterals)):
